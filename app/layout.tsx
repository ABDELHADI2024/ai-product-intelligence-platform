...
export const metadata: Metadata = {
  ...
  title: {
    template: "%s — Witflag",
    default: "Witflag — AI-Powered Phone Intelligence",
  },
  description:
  ...
  openGraph: {
    ...
    siteName: "Witflag",
    locale: "en_US",
    title: "Witflag — AI-Powered Phone Intelligence",
    description:
  ...
  twitter: {
    ...
    title: "Witflag — AI-Powered Phone Intelligence",
    description:
      "Discover, compare, and choose the best tech with AI-powered phone intelligence.",
  },
}
