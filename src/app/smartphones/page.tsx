...
export const metadata: Metadata = {
  title: "Smartphones — ProductIntel",
  description:
    "Explore the best smartphones ranked by AI-powered scoring across camera, battery, gaming, display, and value. Compare top picks from Apple, Samsung, Google, and more.",
  openGraph: {
    title: "Smartphones — ProductIntel",
    description:
