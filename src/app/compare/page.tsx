...
export const metadata: Metadata = {
  title: "Compare Phones — ProductIntel",
  description:
    "Compare phones by camera, battery, gaming, value, and long-term use. See AI-powered winners by use case, not just raw specs.",
  openGraph: {
    title: "Compare Phones — ProductIntel",
    description:
        ...
        <div className="flex items-start gap-2">
          ...
          <p className="text-[11px] leading-relaxed text-zinc-500">
            ...
            {best.label === "Gaming"
              ...
              : best.label === "Value"
              ? `Best value at $${product.price?.toLocaleString() || "—"} with strong overall scores.`
