...
export const metadata: Metadata = {
  title: "Foldable Smartphones — ProductIntel",
  description:
    "Discover foldable smartphones with large inner displays, multitasking features, and premium design. Ranked by AI-powered scoring for display, performance, and value.",
  openGraph: {
    title: "Foldable Smartphones — ProductIntel",
    description:
