...
export const metadata: Metadata = {
  title: "Buying Guides — ProductIntel",
  description:
    "Decision-first buying guides for smartphones and foldable smartphones. Compare by camera, battery, gaming, value, and use case.",
  openGraph: {
    title: "Buying Guides — ProductIntel",
    description:
