...
export const metadata: Metadata = {
  title: "About — ProductIntel",
  description:
    "Witflag's ProductIntel is an AI-native decision engine for smartphones and foldable smartphones. Compare by camera, battery, gaming, value, and long-term use.",
  openGraph: {
    title: "About — ProductIntel",
    description:
    ...
    <div className="flex flex-col">
      ...
      <section className="mx-auto w-full max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="space-y-8 text-sm leading-relaxed text-zinc-400">
          <p>
            ProductIntel by <strong className="text-white">Witflag</strong> is an
