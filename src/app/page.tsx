  ...
  return (
    <>
      ...
      >
        ...
        {/* ── Decision Engine ── */}
        <section className="w-full max-w-[1160px] px-4 sm:px-6 lg:px-8">
          <div className="mb-6 grid gap-px overflow-hidden rounded-2xl border border-white/[0.06] bg-white/[0.03] sm:grid-cols-3">
            {[
              { icon: "🎯", title: "Decision-First Rankings", desc: "Products scored across 6 weighted dimensions — camera, battery, gaming, display, value, and overall — so you pick by what matters, not by specs alone." },
              { icon: "🔍", title: "Intent-Based Search", desc: "Tell us your use case. 'Best camera phone for travel under $900' finds exactly what you need without fiddling with filters." },
              { icon: "↔️", title: "Smart Comparison", desc: "Compare scores, specs, pros, and cons in one view. See which phone wins for camera, battery, gaming, or value." },
            ].map((item) => (
              <div key={item.title} className="flex flex-col gap-3 bg-slate-950/30 p-6">
        ...
        {/* ── Comparison Preview ── */}
        <section className="w-full max-w-[1160px] px-4 sm:px-6 lg:px-8">
          <div className="mb-6 rounded-2xl border border-white/[0.06] bg-gradient-to-br from-cyan-500/3 via-blue-500/3 to-transparent px-6 py-5 backdrop-blur-xl">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="hidden text-[10px] text-zinc-600 sm:inline">AI-powered winner by use case</span>
              </div>
              <Link
                href="/compare"
        ...
        {/* ── CTA ── */}
        <section className="w-full max-w-[1160px] px-4 sm:px-6 lg:px-8">
          <div className="mb-8 mt-2 rounded-2xl border border-white/[0.06] bg-gradient-to-r from-cyan-500/8 to-blue-500/8 px-6 py-6 text-center backdrop-blur-xl sm:px-10 sm:py-7">
            <h2 className="text-lg font-bold text-white sm:text-xl">
              Ready to make a smarter phone decision?
            </h2>
            <p className="mt-1 text-sm text-zinc-500">
              AI-powered rankings, intent-based search, and use-case comparisons.
            </p>
            <Link
              href="/products"
              className="mt-4 inline-flex h-10 items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-cyan-400 to-blue-500 px-6 text-sm font-semibold text-white shadow-lg shadow-cyan-500/20 transition-all hover:from-cyan-500 hover:to-blue-600"
            >
              Start Exploring
